...
/* 
      Opaque definition of process type.
      The defintion refers to a struct that is not fully defnined.  
...
/* 
    ...
    current_process must be NULL if no process is running,
    otherwise it must point to the process_t of the currently running process.
    The variables are extern so that everything inculding "3140_concur.h" can 
    refer to them, but they must be defind somwehre else.   
*/
